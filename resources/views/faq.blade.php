...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/banner/bg-banner.png)">
        <div class="auto-container">
            <h1>Frekuently Asked Questions</h1>
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <section class="ac-container">
                    @foreach ($faqs as $faq)
                    <div>
                        <input id="ac-{{$loop->iteration}}" name="accordion-1" type="radio" checked="ac-1">
                        <label for="ac-{{$loop->iteration}}"> {{$faq->judul_page}}</label>
                        <article class="ac-small">
                            <p class="text">{!!$faq->konten_page!!}</p>
                        </article>
                    </div>
                    @endforeach
                </section>

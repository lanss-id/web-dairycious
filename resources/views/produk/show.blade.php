                                    ...
                                    <div class="instagram-gallery">
                                        <div class="outer-box clearfix">
                                            <div class="mx-auto" style="width: 500px; padding: 50px;">
                                                <figure class="image"><a href="https://via.placeholder.com/500x500" class="lightbox-image" ><img src="{{ asset ('/assets/admin/assets/media/derma_produk/500/'. $produk->image) }}" alt="" widht: 100px></a></figure>
                                            </div>
                                        </div>
                                    </div>
                                </div>

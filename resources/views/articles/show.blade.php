                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                            <ul class="navigation menu-left clearfix">
                                ...
                                <li class="dropdown"><a href="/product">Order</a>
                                    <ul>
                            ...
                            <ul class="navigation menu-right clearfix">
                                <li class="current"><a href="{{ url ('/articles') }}">Artikel</a></li>
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="instagram-gallery">
                                        <div class="outer-box clearfix">
                                            <div class="mx-auto" style="width: 500px; padding: 50px;">
                                                <figure class="image"><a href="https://via.placeholder.com/500x500" class="lightbox-image" ><img src="/assets/admin/assets/media/posting/{{$article->image}}" alt="" widht: 100px></a></figure>
                                            </div>
                                        </div>
                                    </div>
                                </div>

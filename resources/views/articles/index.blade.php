                    ...
                    <div class="inner-box">
                        <div class="image-column">
                            <div class="inner-column">
                                <figure class="image"><img src="/assets/admin/assets/media/posting/{{$art->image}}" alt=""></figure>
                            </div>
                        </div>
                        <div class="content-column">
                            <div class="inner-column">
                                <h3><a href= "/articles/{{$art->id_posting}}">{!! str_limit(strip_tags($art->judul), $limit = 20, $end = '...') !!} </a></h3>
                                <div class="auto-container">
                                    <ul class="post-info">
                                ...
                                <div class="text container"> 
                                    {!! str_limit(strip_tags($art->content), $limit = 50, $end = '...') !!} 
                                </div>

...
<div class="page-wrapper">
                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                            <ul class="navigation menu-left clearfix">
                                ...
                                <li class="current"><a href="/reseller">Reseller</a></li>
    ...
    <section class="page-title" style="background-image:url(images/banner/bg-banner.png)">
        <div class="auto-container">
            <h1>Cara Jadi Reseller</h1>
            <ul class="page-breadcrumb">
                <li><a href="/">home</a></li>
                <li>Cara Jadi Reseller</li>
            </ul>
        </div>
    </section>
    <!--End Page Title-->
                            ...
                            <div class="inner-box">
                                <div class="image-column">
                                    <div class="inner-column">
                                        <figure class="image"><img src="images/banner/cara jadi reseller.png" alt=""></figure>
                                ...
                                <div class="content-column">
                                    <div class="inner-column">
                                        <ul class="post-info">
                                            ...
                                            <li><span class="icon fa fa-bookmark"></span> <a href="#">{{$gambar->category}}</li>
                                        </ul>
                                ...
                                <div class="two-column row">
                                    <div class="image-column col-lg-6 col-md-12">
                                        <figure class="image"><img src="images/main-slider/REK_9447.jpg" alt=""></figure>
                                    </div>
                                ...
                                <center>
                                    <a href="https://wa.link/2tfx96" class="theme-btn btn-style-two large border-sky" target="_blank" rel="noopener noreferrer"><span></span>Jadi Reseller<span></span></a>
                                </center>
                            </div>
                        </div>
